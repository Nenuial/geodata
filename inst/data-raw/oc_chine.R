...
readxl::read_excel(here::here("inst/extdata/oc_chine/nbs/population/2018_china_nbs_population_by_gender_and_region.xlsx")) |>
...
usethis::use_data(oc_chine_2018_sex_ratio_par_region, overwrite = T)
