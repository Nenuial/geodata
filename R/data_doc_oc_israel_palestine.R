...
#'
#' @format Un tibble avec 2 colonnes et 69 lignes
#' \describe{
#'   \item{year}{L'année d'immigration}
#'   \item{immigration}{Nombre absolu de personnes}
#' }
...
#'
#' @format Un tibble avec 3 colonnes et 5 lignes
#' \describe{
#'   \item{country}{Le pays de naissance}
#'   \item{continent}{Le continent de naissance}
#'   \item{population}{Nombre absolu de personnes}
#' }
...
#' \describe{
#'   \item{period}{La période}
#'   \item{immigration}{Le nombre approximatif de Juifs qui immigrent}
#' }
#' @source <https://www.bpb.de/themen/migration-integration/laenderprofile/english-version-country-profiles/58400/historical-development-of-jewish-immigration/>
#' @md
